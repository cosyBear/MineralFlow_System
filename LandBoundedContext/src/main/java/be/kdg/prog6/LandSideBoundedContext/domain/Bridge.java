...
//
//    public Bridge(Integer bridgeNumber, double currentTruckWeight, LicensePlate licensePlate, MaterialType materialType, SellerId sellerId, LocalDateTime timestamp) {
