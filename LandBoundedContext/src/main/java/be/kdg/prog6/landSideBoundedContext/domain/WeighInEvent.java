...
public class WeighInEvent {
    ...
    public WeighInEvent(UUID weighBridgeTicketId, LicensePlate licensePlate, SellerId sellerId, double weight, MaterialType materialType, LocalDateTime weighInTime, WarehouseStatus warehouseStatus) {
