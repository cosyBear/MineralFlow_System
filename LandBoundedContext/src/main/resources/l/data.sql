...
VALUES
    (UNHEX(REPLACE('f8a9f9c0-45e2-4f32-809f-2d4a73c4083b', '-', '')), @seller_id, 1, 0.0), -- IRON (MaterialType index 1)
    (UNHEX(REPLACE('c0e9a5a3-bbfd-4e73-bef7-9a2a8bce394b', '-', '')), @seller_id, 0, 0.0), -- GYPSUM (MaterialType index 0)
    (UNHEX(REPLACE('aedcb3a5-f2a6-4ed8-8090-0d92c3d6955c', '-', '')), @seller_id, 2, 0.0), -- CEMENT (MaterialType index 2)
    (UNHEX(REPLACE('acdd75b0-0712-4ef1-870f-67a8d0d7bc18', '-', '')), @seller_id, 3, 0.0), -- PETCOKE (MaterialType index 3)
    (UNHEX(REPLACE('b03f68bb-6606-482d-8007-dc7f94acb1e5', '-', '')), @seller_id, 4, 0.0); -- SLAG (MaterialType index 4)
