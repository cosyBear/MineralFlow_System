INSERT INTO appointments (id, license_plate, seller_id, material_type_entity, time, status)
VALUES
...
VALUES (UNHEX(REPLACE('f8a9f9c0-45e2-4f32-809f-2d4a73c4083b', '-', '')), @seller_id, 'GYPSUM',
       ...
       (UNHEX(REPLACE('b03f68bb-6606-482d-8007-dc7f94acb1e5', '-', '')), @seller_id, 'SLAG', 0);
